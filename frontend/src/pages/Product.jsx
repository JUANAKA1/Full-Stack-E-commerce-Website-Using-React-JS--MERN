      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border border-gray-300 px-6 text-sm text-gray-500">
          <p>
            ...
            expedita obcaecati. Et unde distinctio error dicta laudantium itaque
            omnis quisquam nesciunt harum rerum maxime voluptatem illum,
            molestias, soluta accusamus quibusdam?
          </p>
          <p>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Saepe
            praesentium et a beatae, atque dolor repellat! Perspiciatis dolore
            doloribus, iste eaque exercitationem natus accusamus repudiandae,
            quibusdam cupiditate, hic fuga sapiente.
          </p>
        </div>
      </div>
      {/* similar products */}
